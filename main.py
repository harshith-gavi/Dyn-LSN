...
parser.add_argument('--prun_rate', nargs='+', type=float, default=[0.01, 0.2], help = 'Pruning rate per layer')
parser.add_argument('--reg_rate', nargs='+', type=float, default=[0.01, 0.1], help = 'Regeneration rate per layer')
